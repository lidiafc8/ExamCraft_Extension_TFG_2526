...
| HU-21 | Como profesor quiero poder volver a hacer una consulta (HU-20) a partir de una solución proporcionada por el sistema, usando un botón para volver a generar la solución, para que se muestre otra nueva posible solución una vez pulsado. | Must Have | M |
| HU-22 | Como profesor quiero poder volver a generar una nueva solución a partir de otra dada previamente pulsando un botón, para así poder conocer otras soluciones alternativas. | Could Have | M |
...
| HU-25 | Como profesor quiero que la solución proporcionada tenga en cuenta siempre los exámenes anteriormente creados y almacenados en el sistema, para así evitar que no me genere soluciones similares a las ya dadas en otras ocasiones, a menos que yo lo especifique explícitamente (HU-10). | Must Have | XL |
