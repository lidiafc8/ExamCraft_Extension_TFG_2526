...
En este ejercicio, añadiremos la funcionalidad de gestión de estancias en la residencia de la clínica. Concretamente, tendremos la clase “BoardingStay”, que representa la reserva y los datos de la estancia de una mascota en nuestra residencia, y la clase “Kennel”, que representa cada uno de los espacios individuales disponibles en la residencia.

La clase BoardingStay contendrá la fecha de inicio de la estancia (“startDate”), la fecha de finalización (“endDate”), las instrucciones especiales de cuidado para la mascota (“specialCareInstructions”) y la tarifa diaria de la estancia (“dailyRate”). Un BoardingStay se asignará a una única mascota y ocupará una única jaula de la residencia. La clase Kennel, por su parte, incluirá su tamaño (“size”), su ubicación dentro de la clínica (“location”) y la capacidad máxima de mascotas que puede albergar (“capacity”).
