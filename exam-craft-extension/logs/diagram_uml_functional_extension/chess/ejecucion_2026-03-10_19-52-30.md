...
classDiagram
    ...
    BaseEntity <|-- NamedEntity
    NamedEntity <|-- ChessMatch
    BaseEntity <|-- Achievement %% Achievement hereda de BaseEntity siguiendo el patrón de otras entidades principales.
    ...
    User "1" <-- "0..n" UserAchievement : <font color=red>achievedBy</font>
    Achievement "1" <-- "0..n" UserAchievement : <font color=red>forAchievement</font>
