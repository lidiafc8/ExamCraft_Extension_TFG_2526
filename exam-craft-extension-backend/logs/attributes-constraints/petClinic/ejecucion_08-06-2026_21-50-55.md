...
Pet "0..n" --> "1" PetType
Pet "1" <-- "0..n" Visit
Pet "1" --> "1..n" BehavioralIssue : suffers
BehavioralIssue "1" --> "1..n" BehavioralSession : <font color=red>requires</font>
BehavioralSession "0..n" --> "1" Vet : <font color=red>performedBy</font>
BehavioralSession "0..n" --> "1" Pet : <font color=red>forPet</font>
%% Style
style BehavioralIssue stroke:red,color:red
style BehavioralSession stroke:red,color:red
```
...
## 4. Respuesta
Modificar las clases “BehavioralIssue” y “BehavioralSession” para que sean entidades. Estas deben tener los siguientes atributos y restricciones:

**Para la clase BehavioralIssue:**
...
- Un atributo de tipo cadena de caracteres (String) llamado “description” obligatorio (no puede ser nulo), que debe tener una longitud mínima de 10 caracteres y máxima de 255 y que no puede estar formada por caracteres vacíos (espacios, tabuladores, etc.).
- El atributo de tipo entero (Integer) llamado “severity”, que representa el nivel de gravedad del problema de comportamiento. Este atributo será obligatorio y tendrá un valor mínimo de 1 y un valor máximo de 5.
- El atributo de tipo fecha (LocalDate) llamado “diagnosisDate”, que representa la fecha en que se diagnosticó el problema de comportamiento. Seguirá el formato “dd/MM/yyyy”. Este atributo debe ser obligatorio y se almacenará en la BD con el nombre de columna “diagnosis_date”.

**Para la clase BehavioralSession:**

- El atributo de tipo entero (Integer) llamado “id” actuará como clave primaria en la tabla de la base de datos relacional asociada a la entidad.
- El atributo de tipo fecha (LocalDate) llamado “date”, que representa la fecha en que se realizó la sesión de terapia conductual. Seguirá el formato “dd/MM/yyyy”. Este atributo debe ser obligatorio y se almacenará en la BD con el nombre de columna “session_date”.
- El atributo de tipo entero (Integer) llamado “durationMinutes”, que representa la duración de la sesión en minutos. Este atributo será obligatorio y tendrá un valor mínimo de 15 minutos y un valor máximo de 180 minutos.
- El atributo de tipo cadena caracteres (String) llamado “notes” opcional, para registrar los comentarios y observaciones del veterinario durante la sesión.

No modifique por ahora las anotaciones @Transient de las clases. Modificar las interfaces BehavioralIssueRepository y BehavioralSessionRepository alojada en el mismo paquete para que extienda a CrudRepository.