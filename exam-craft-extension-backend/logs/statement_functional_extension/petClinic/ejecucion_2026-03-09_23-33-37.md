...
En este ejercicio, añadiremos la funcionalidad de gestión de seguros para mascotas. Concretamente, tendremos la clase “InsurancePolicy”, que representa una póliza de seguro contratada para una mascota y que cuenta con un número de póliza único, la fecha de inicio de la cobertura, la fecha de fin de la cobertura y el tipo de plan contratado. Además, tendremos la clase “Claim”, que registra una reclamación de seguro realizada para una visita veterinaria, indicando la fecha en que se presentó la reclamación, el importe total solicitado a la aseguradora, el importe final aprobado por la aseguradora, el estado actual de la reclamación y cualquier información o comentario adicional. Una póliza de seguro se contrata para una mascota específica y es gestionada por un propietario, mientras que las reclamaciones se asocian a una póliza existente y están vinculadas a una visita veterinaria donde se originó el servicio.
