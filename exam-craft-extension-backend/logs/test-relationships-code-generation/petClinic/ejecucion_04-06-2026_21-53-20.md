...
Elimine las anotaciones @Transient de los métodos y atributos que las tengan en las entidades `Subscription` y `SubscriptionPayment`. Se pide crear las siguientes relaciones entre las entidades:
