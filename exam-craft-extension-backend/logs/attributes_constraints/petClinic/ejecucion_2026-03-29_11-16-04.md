...
**Dominio:** PETCLINIC
**Fecha:** 29/3/2026, 13:16:04

## Índice
- [1. Hidden Context](#1-hidden-context)
- [2. Selected Exam](#2-selected-exam)
...
Pet "0..n" --> "1" PetType
Pet "1" <-- "0..n" Visit
LabResult "0..n" --> "1" LabTest : ofTest >
LabResult "0..n" --> "1" Pet : forPet >
LabResult "0..n" --> "1" Visit : requestedIn >
...
## 4. Response
Modificar las clases “LabTest” y “LabResult” para que sean entidades. Estas deben tener los siguientes atributos y restricciones:
...
- El atributo de tipo cadena de caracteres (String) llamado “description” obligatorio, que proporcionará un detalle sobre la prueba. Este atributo tendrá una longitud mínima de 10 caracteres y máxima de 255, y no puede estar formada por caracteres vacíos.
- El atributo de tipo doble (Double) llamado “cost” obligatorio, que representa el coste asociado a la realización de la prueba de laboratorio. Este atributo tendrá un valor mínimo de 0.01 (la prueba no puede ser gratuita) y un valor máximo de 1000.00.
- El atributo de tipo cadena de caracteres (String) llamado “sampleType” obligatorio, que especifica el tipo de muestra biológica necesaria. Únicamente podrá tomar los valores “BLOOD”, “URINE”, “TISSUE”, “SWAB”, “FLUID”.

**Para la clase LabResult:**

- El atributo de tipo fecha (LocalDate) llamado “resultDate”, que representa la fecha en que se obtuvo el resultado de la prueba. Seguirá el formato “dd/MM/yyyy”. Este atributo debe ser obligatorio.
- El atributo de tipo cadena de caracteres (String) llamado “summary” opcional, para registrar un resumen de los hallazgos. Si se proporciona, deberá tener una longitud máxima de 500 caracteres.
- El atributo de tipo doble (Double) llamado “numericValue” opcional, que representa un valor cuantitativo si la prueba lo requiere. Si toma valor, deberá ser un número estrictamente positivo y no podrá exceder 10000.00.
- El atributo de tipo cadena de caracteres (String) llamado “unitOfMeasure” opcional, que representa la unidad de medida del valor numérico (por ejemplo, "mg/dL", "U/L"). Si toma valor, debe tener una longitud mínima de 1 caracter y máxima de 10, y no puede estar formada por caracteres vacíos.
- El atributo de tipo booleano (Boolean) llamado “isAbnormal” obligatorio, que indica si el resultado de la prueba se considera anormal.

No modifique por ahora las anotaciones @Transient de las clases. Modificar las interfaces LabTestRepository y LabResultRepository alojada en el mismo paquete para que extienda a CrudRepository.