...
Round "0..1" <-- "1..n" ChessMatch
Round "1..n" --> "1" Tournament
Round "0..n" --> "2..n" User : participants
Tournament "0..n" --> "2..n" User : participants
ChessMatch "1" *--> "1" ChessBoard
...
%% Style
style BaseEntity stroke:black,color:black
style Authorities stroke:black,color:black
style User stroke:black,color:black
style NamedEntity stroke:black,color:black
...
linkStyle 7 stroke:blue // Round "0..n" --> "2..n" User : participants
linkStyle 8 stroke:red  // Tournament "0..n" --> "2..n" User : participants
linkStyle 10 stroke:blue // ChessMatch "0..n" --> "1" User : creator
linkStyle 11 stroke:blue // ChessMatch "0..n" --> "1" User : opponent