...
classDiagram
    ...
    %% --- Asociaciones y Relaciones ---
    Owner "1" -- "0..n" Pet : owns > %% This relation is from a different context, removing it
    Vet "0..n" --> "0..1" Specialty %% This relation is from a different context, removing it
    Pet "0..n" --> "1" PetType %% This relation is from a different context, removing it
    Visit "0..n" --> "1" Pet %% This relation is from a different context, removing it
    Visit "0..n" --> "1" Vet %% This relation is from a different context, removing it
    Authorities "0..n" -- "" User
    ...
    %% --- Nuevas Relaciones de la Extensión (Rojas) ---
    Challenge "0..n" --> "1..n" ChessMatch
    Challenge "0..n" --> "1" ChallengeObjective
    Challenge "0..n" --> "0..n" User : participant
