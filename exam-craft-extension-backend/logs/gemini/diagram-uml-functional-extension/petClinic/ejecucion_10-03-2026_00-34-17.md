...
%% Style
%% Clases base (negro por defecto) - No necesitan estilo explícito para texto/borde negro
%% Clases proporcionadas (azul)
style Pet stroke:blue,color:blue
style PetType stroke:blue,color:blue
style Disease stroke:blue,color:blue
style Visit stroke:blue,color:blue

%% Clases a implementar (rojo)
style Symptom stroke:red,color:red
style Treatment stroke:red,color:red

%% Estilo de línea para relaciones (siguiendo el ejemplo para el índice de los enlaces)
%% Las etiquetas de las relaciones también tienen su color específico
linkStyle 5 stroke:blue %% Visit "0..n" --> "0..1" Disease : diagnosed
linkStyle 7 stroke:blue %% PetType "0..n" <-- "0..n" Disease : can develop
linkStyle 6 stroke:red  %% Visit "0..n" --> "0..n" Symptom : present
linkStyle 8 stroke:red  %% Disease "1..n" <-- "0..n" Symptom : includes
linkStyle 9 stroke:red  %% Disease "1..n" <-- "0..n" Treatment : recommended for