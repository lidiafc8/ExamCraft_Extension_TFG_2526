...
**Ejercicio:** DIAGRAM-UML-FUNCTIONAL-EXTENSION
**Dominio:** PETCLINIC
**Fecha:** 8/6/2026, 13:10:14

## Índice
- [1. Contexto Oculto](#1-contexto-oculto)
- [2. Enunciado De Contexto](#2-enunciado-de-contexto)
...
Pet "1" <-- "0..n" BoardingStay : <font color=red>hosts</font>
Vet "1" <-- "0..n" BoardingStay : <font color=red>supervises</font>
AccommodationUnit "1" <-- "0..n" BoardingStay : <font color=red>assignedTo</font>

%% Style
style BoardingStay stroke:red,color:red
style AccommodationUnit stroke:red,color:red
```