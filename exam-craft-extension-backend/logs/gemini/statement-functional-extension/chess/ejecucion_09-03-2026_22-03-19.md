...
En este ejercicio, añadiremos la funcionalidad de gestión de logros y recompensas para los usuarios del juego. Concretamente, tendremos una clase “Achievement” que representa los distintos logros que los jugadores pueden desbloquear, como "Primera victoria", "Diez jaque mates" o "Capturar un rey con peón". Cada logro tendrá una descripción de cómo se consigue, una cantidad de puntos asociados y un nivel de rareza. Además, contaremos con la clase “UserAchievement”, que registrará cuándo un usuario ha conseguido un logro específico.
