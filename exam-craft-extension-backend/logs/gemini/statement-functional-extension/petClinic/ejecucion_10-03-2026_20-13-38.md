...
*	Sé lo más creativo posible. Evita que se trate sobre el alojamiento y guardería de mascotas
...
En este ejercicio, añadiremos la funcionalidad de gestión de vacunas y registros de vacunación para las mascotas. Concretamente, se proporciona una clase “Vaccine” que representa las diferentes vacunas disponibles en la clínica, incluyendo atributos para el fabricante, la dosis recomendada y la duración de la inmunidad que proporciona. Además, tendremos la clase “VaccinationRecord” que representa el registro de la administración de una vacuna a una mascota. Esta clase contiene atributos como la fecha de administración, la fecha de la próxima dosis y el número de lote de la vacuna utilizada. La clase “VaccinationRecord” se relaciona con la mascota que recibe la vacuna, la vacuna específica administrada y el veterinario que llevó a cabo la vacunación.
