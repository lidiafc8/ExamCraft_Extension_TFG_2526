...
En este ejercicio, añadiremos la funcionalidad de gestión de servicios de alojamiento y cuidado de mascotas (conocido como "boarding" o residencia). Concretamente, tendremos la clase "Kennel", que representa las diferentes áreas o jaulas disponibles en la clínica para alojar mascotas. Cada Kennel cuenta con atributos para definir su capacidad máxima, la tarifa diaria de ocupación y una descripción de las comodidades que ofrece. Además, tendremos la clase "BoardingStay", que registra la información detallada de cada estancia de una mascota en un Kennel. Esta clase incluirá la fecha de inicio del alojamiento, la fecha de finalización prevista, cualquier instrucción especial relevante para el cuidado de la mascota durante su estancia y el coste total asociado al servicio.

La relación principal establece que cada BoardingStay se asigna a una Pet específica, indicando la mascota que se aloja. Así mismo, cada BoardingStay se realiza en un Kennel concreto.
