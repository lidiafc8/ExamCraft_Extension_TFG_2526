...
En este ejercicio, añadiremos la funcionalidad de gestión de **servicios de adiestramiento para mascotas**. Concretamente, se proporciona una clase “**TrainingCourse**” que representa los distintos cursos de adiestramiento disponibles en la clínica, como “Obediencia Básica” o “Agilidad Canina”. Esta clase contendrá una descripción detallada de los objetivos y contenido del curso, la duración total en horas, su coste de matriculación y la capacidad máxima de mascotas. Además, se proporciona la clase “**Enrollment**” para gestionar la inscripción de las mascotas en estos cursos. Un `Enrollment` registrará la fecha en la que se realizó la inscripción, el estado actual de la participación de la mascota en el curso y, opcionalmente, una calificación final obtenida. La clase `TrainingCourse` se relaciona con el tipo de mascota al que está específicamente diseñado para aplicar.
