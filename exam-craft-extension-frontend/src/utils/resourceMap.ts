...
import baseClassesExamples from "bundle-text:../prompts/resources/base_classes_structure_examples_previous_exams.md"
import extensionExamples from "bundle-text:../prompts/resources/functional_extension_examples_previous_exams.md"
...
export const RESOURCE_MAP: Record<string, string> = {
  "functional_extension_examples_previous_exams.md": extensionExamples,
  ...
  "base_classes_structure_examples_previous_exams.md": baseClassesExamples
}
