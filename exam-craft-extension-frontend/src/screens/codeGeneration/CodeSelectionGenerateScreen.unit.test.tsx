...
describe("CodeSelectionGenerateScreen – Pruebas Unitarias", () => {
  ...
  it("renderiza el badge con la pregunta de selección", () => {
    ...
    expect(screen.getByText(/qué parte de código te gustaría generar primero/i)).toBeInTheDocument();
  });
  ...
  it("ningún botón del menú está deshabilitado", () => {
    ...
    expect(screen.getByRole("button", { name: "Clases base" })).not.toBeDisabled();
