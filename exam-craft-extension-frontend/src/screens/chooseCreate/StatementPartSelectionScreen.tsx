...
export default function StatementPartSelectionScreen({ onBack, onWelcome, onCreateExamByParts, onFunctionalExtension, onAttributesConstraints, onEntityRelationships }: Props) {
  return (
