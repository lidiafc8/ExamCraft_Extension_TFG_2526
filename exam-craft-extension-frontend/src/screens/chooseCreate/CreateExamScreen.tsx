      ...
      <main className="main-content">
        ...
        <div className="cards-container">
          ...
          <button className="action-card" onClick={onCreateExamByParts}>
            <span className="parts-exam-icon"><img src={partsExamIcon} alt="Icono examen" className="card-icon" /></span> 
            <span className="card-label">Crear examen por partes</span>
          </button>

          <button className="action-card">
              <span className="complete-exam-icon"><img src={completeExamIcon} alt="Icono archivo" className="card-icon" /></span> {/* Icono carpeta */}
