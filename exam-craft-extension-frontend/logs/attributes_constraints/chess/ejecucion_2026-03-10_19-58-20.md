...
Modificar las clases “Achievement” y “UserAchievement” para que sean entidades. Estas deben tener los siguientes atributos y restricciones:
...
- El atributo de tipo entero (Integer) llamado “points”, que representa el valor en puntos que se sumará al perfil del usuario. Este atributo será obligatorio y tendrá un valor mínimo de 1 y un valor máximo de 1000.

**Para la clase UserAchievement:**

- El atributo de tipo entero (Integer) llamado “id” actuará como clave primaria en la tabla de la base de datos relacional asociada a la entidad.
- El atributo de tipo fecha (LocalDate) llamado “achievedDate”, que representa la fecha en que el jugador consiguió el logro. Este atributo debe ser obligatorio y seguirá el formato “dd/MM/yyyy”.
- El atributo de tipo cadena de caracteres (String) llamado “criteriaMet” opcional, que explica brevemente cómo se ha cumplido dicho logro. Si toma valor, debe tener una longitud mínima de 5 caracteres y máxima de 100 y no puede estar formada por caracteres vacíos (espacios, tabuladores, etc.).

No modifique por ahora las anotaciones @Transient de las clases. Modificar las interfaces “AchievementRepository” y “UserAchievementRepository” alojada en el mismo paquete para que extienda a CrudRepository. No olvide especificar sus parámetros de tipo.