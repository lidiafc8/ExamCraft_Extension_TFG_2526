...
En este ejercicio, añadiremos la funcionalidad de gestión de logros y recompensas para los usuarios de nuestra implementación del juego del ajedrez. Concretamente, se proporciona una clase “Achievement” que representa los distintos logros que los usuarios pueden conseguir al jugar partidas, la cual contiene una descripción, los puntos que otorga al ser completado, un valor objetivo numérico y un criterio que define la acción necesaria para conseguirlo. Además, tendremos la clase “UserAchievement” que registrará el progreso actual de cada usuario hacia un logro, y la fecha en que este fue completado. Las clases para las que realizaremos el mapeo objeto-relacional como entidades JPA se han señalado en rojo. Realizaremos una serie de ejercicios basados en funcionalidades que implementaremos en el sistema, y validaremos mediante pruebas unitarias.